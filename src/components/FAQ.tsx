...
const faqs = [
  {
    ...
    a: "Готовый шаблон — от 99 000 ₽. Кастом Pro — от 399 000 ₽. Корпоративный — от 999 000 ₽. Свяжитесь для оценки вашего кейса — обычно отвечаем за 2 часа.",
  },
  {
  ...
  },
  {
    ...
    a: "50% до старта, 50% после запуска. Для проектов от 800 000 ₽ возможна разбивка на 3 части. Работаем с ИП, ООО, физлицами. Безналичный расчёт, договор, акты.",
  },
  {
    q: "Сколько стоит поддержка после запуска?",
    a: "30 дней — бесплатно. Дальше — тариф от 8 000 ₽/мес с временем реакции до 2 часов. Можно обслуживаться самостоятельно или передать нам.",
  },
  {
    q: "Можете сделать проект под мой бренд?",
    a: "Конечно. Кастомные проекты — от 399 000 ₽. Полностью уникальный дизайн, никаких шаблонов. Бриф → концепты → дизайн → разработка → запуск.",
  },
];
